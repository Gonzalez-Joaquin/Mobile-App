    ...
    return (
      <div>
        <button className={`AddButton ${ButtonState === 'open' ? 'buttonactive' : ''} ${ButtonState === 'unfocused' ? 'unfocused' : ''}`} onClick={handleClick}>
          ...
          {count === 1 && (
            <div className='trashbutton' onClick={minus}>
          ...
          <span className={`addbuttontext iconhide ${ButtonState === 'open' ? 'iconshow' : ''} ${ButtonState === 'unfocused' ? 'iconshow textshow flex' : ''} ${animation === 'plus' ? 'plusanimation' : ''} ${animation === 'minus' ? 'minusanimation' : ''}`}>{count}</span>
