...
<span className={`addbuttontext iconhide ${ButtonState === 'open' ? 'iconshow' : ''} ${ButtonState === 'unfocused' ? 'iconshow textshow' : ''}`}>{count}</span>
      <svg className={`${ButtonState === 'unfocused' ? 'iconhide' : ''}`} onClick={increment} width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<svg className="minus" onClick={decrement} width="11" height="2" viewBox="0 0 11 2" fill="none" xmlns="http://www.w3.org/2000/svg">
<line x1="-6.55671e-08" y1="1.25" x2="11" y2="1.25" stroke="#98A0B6" strokeWidth="1.5"/>
</svg>

<span className="normalcount">{count}</span>
<svg className="plus" onClick={increment} width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
